    ...
    <div class="mt-3 position-absolute bottom-0 zindex col-12 " v-if="modal" >
      <div class="col col-11 bg-white px-2 ms-3 rounded-5 text-black">
        ...
        <div class="d-flex justify-content-between text-black text-end px-2 font-map ">
          <div class="mappagebutton col-2 text-center py-3 justify-content-center ">
        ...
        <div class="d-grid col-12 mx-auto pt-3 pb-3">
          <button class="btn btn-primary  p-3" type="button" @click="navigateToCardDetail(target,customerName.loanSurveyEconomidTypeId,customer.loanDetail.loanEconomicTypeId)">
            انجام نظارت
          </button>
        </div>
      </div>
...
const navigateToCardDetail = (cardName: string,loanSurveyEconomidTypeId,loanEconomicTypeId) => {
  const newData = loanSurveyEconomidTypeId === 0 ? loanEconomicTypeId : data;

  router.push({ path: "/MonitoringRegistrationPage", query: { cardName, loanEconomicTypeId: loanSurveyEconomidTypeId } });
};
